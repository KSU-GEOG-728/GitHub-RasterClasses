...
"""
    File name: demo13_5.py
    Author: Shawn Hutchinson
    Description: Example script that performs map algebra on a raster object with the "snapRaster" environment
...
arcpy.env.snapRaster = "LANDSAT8_20150609"
...
try:
    if arcpy.CheckExtension("Spatial") == "Available":
        ...
        outGrid.save(os.path.join(outWorkspace, "elev_ft_kz5"))
